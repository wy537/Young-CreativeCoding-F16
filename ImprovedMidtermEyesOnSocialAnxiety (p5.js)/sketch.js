...
function draw() {
  col = map(chaos, 0, 1100, 0, 600);
  background(col/5, 255-col/2, col/20);
...
//Creating heading and subheading at top of screen
  ...
  println(chaos);
  println(dialation);
  fill(0.1*chaos, 50+0.1*chaos, dialation*chaos);
  dialation = random(-1,1)*0.01*chaos
  if (chaos>1000 & chaos < 1099){
    dialation *= 30;
  }
  else if (chaos > 1100){
    dialation = 0;
  ...
  ellipse(mouseX-dialation, mouseY+dialation, (50+0.1*chaos), (50+0.1*chaos));
